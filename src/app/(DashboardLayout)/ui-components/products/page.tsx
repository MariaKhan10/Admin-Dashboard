        ...
        <div key={product._id} className="bg-white shadow-md p-4 rounded-lg relative flex flex-col">
          ...
          <div className="mt-auto flex justify-between space-x-2">
            <button
              ...
              className="bg-blue-500 mt-2 text-white px-7 py-2 rounded hover:bg-blue-700 transition w-full sm:w-auto"
            >
              Edit
            </button>
            <button
              onClick={() => handleDelete(product._id)}
              className="bg-red-500 mt-2 text-white px-6 py-2 rounded hover:bg-red-700 transition w-full sm:w-auto"
            >
              Delete
            </button>
          </div>
